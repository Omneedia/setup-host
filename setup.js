...
function getIPAddress() {
    if (fs.existsSync(__dirname + '../Hypervisor/.ip')) return fs.readFileSync(__dirname + '/../Hypervisor/.ip', 'utf-8');
...
function makeTLS(A) {
    ...
    request({
        ...
        fs.writeFileSync(__dirname + path.sep + '..' + path.sep + 'hypervisor' + path.sep + 'config' + path.sep + 'hypervisor.json', JSON.stringify(conf, null, 4));
        // install service
